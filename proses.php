...
class proses extends fb{
	...
	private function getDatabase(){
		...
		if (!file_exists($file)){
			$arr	= [
				...
				'info'	=> [
					[
						'Aplikasi Display BMCK',
						'Selamat datang di aplikasi Display BMCK, aplikasi baru saja diinstal dan belum ada data, silakan masuk ke menu admin untuk mengganti data',
						'Display | BMCK',
						true	// active?
					],
					[
				...
				'running_text' => [
					'Selamat datang di aplikasi Display BMCK',
					'Cara masuk silahkan ketik ".../bmck/login.php" lalu masukan user "admin" pass "admin".',
			...
			foreach($_FILES as $file){
				if($file['size']>0){
					...
					if(!in_array($ext,$allowed_ext) ) {
						...
						move_uploaded_file($file['tmp_name'], "display/vidio/".time().$i.'.'.$ext);
					}
				}
				$i++;
			}
	...
	private function getVidio(){
		$dir	= 'display/vidio/';
		$files	= array_diff(scandir($dir),array('.','..','Thumbs.db'));
		return $files;
	}
	
	private function vidioDelete(){
		$dir	= 'display/vidio/';
		$file	= $this->dt;
	...
	private function vidio(){
		$db = $this->database;
		$id = 'vidio';
		$videos = $this->getVideos();
		ob_start();
		echo '
			<section class="content-header content-dynamic section-vidio">
				<div class="row">
		';
		?>
		<div class="col-md-12 col-sm-12 col-xs-12">
			<form method="post" class="form-file" enctype="multipart/form-data">
				<div class="box box-info">
					...
					<div class="box-body">
						<div class="input-group">
							<span class="input-group-addon">File video</span>
							<input type="file" multiple="" class="form-control input-sm" placeholder="" data-proses="saveVideo">
						</div>
						<div class="input">
							<small>
							- Ext file yang didukung :  <b>.mp4</b><br>
							- Ukuran maksimal <b>50Mb</b><br>
		...
		<div class="col-md-4 col-sm-6 col-xs-12">
			<div class="small-box">
				<video width="100%" height="auto" controls>
					<source src="display/videos/<?=$v?>" type="video/mp4">
				</video>
				<div class="inner"></div>
				...
				<div class="col-md-6">
				  ...
				  <div class="box box-widget widget-user-2">
					...
					<div class="widget-user-header bg-aqua-active">
					  ...
					  <link rel="icon" type="image/png" href="../bmck.png"/>
					  </div>
					  <!-- /.widget-user-image -->
					  <h3 class="widget-user-username">Display | BMCK</h3>
					  <h5 class="widget-user-desc">Media Untuk Informasi</h5>
					</div>
					<div class="box-footer no-padding" style="overflow:hidden">
					  <ul class="nav nav-stacked">
						<li>
							<a class="row">
								<div class="col-xs-5" style="text-align:right">Release Date</div>
								<div class="col-xs-7"><span class="badge bg-blue">-</span></div>
							</a>
						</li>
						<li>
							<a class="row">
								<div class="col-xs-5" style="text-align:right">Reedit</div>
								<div class="col-xs-7"><span class="badge bg-aqua">March 2023</span></div>
							</a>
						</li>
					  </ul>
					</div>
